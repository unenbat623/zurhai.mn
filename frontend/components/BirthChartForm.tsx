...
export default function BirthChartForm({ onSave }: Props) {
  ...
  const getInputFieldClasses = (name: keyof typeof touched) => {
    const base = "w-full min-w-0 bg-slate-950/50 border rounded-xl py-3 pl-11 pr-11 focus:outline-none transition-all duration-300 text-white";
  ...
  return (
    <motion.div
      ...
      className="glass-card relative mx-auto w-full max-w-xl overflow-hidden border-white/10 bg-slate-900/40 p-5 sm:p-6 md:p-10"
    >
      {/* Progress Bar */}
      ...
      <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8" noValidate>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="relative">
            <label htmlFor="birthTime" className="mb-3 ml-1 flex flex-wrap items-center justify-between gap-2 font-mono text-[10px] font-bold uppercase tracking-[0.3em] text-slate-400">
