      ...
      {isOpen && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-3 sm:p-4">
          ...
          <motion.div
            ...
            className="glass-card relative max-h-[calc(100vh-24px)] w-full max-w-4xl overflow-y-auto border-indigo-500/20 bg-slate-900 p-5 sm:p-8"
          >
            <button 
              onClick={onClose}
            ...
            <div className="text-center mb-12">
              ...
              <h2 className="sleek-glow mb-2 text-3xl font-serif tracking-tight text-white md:text-5xl">Astra <span className="text-indigo-400">Plus</span> рүү сайжруулах</h2>
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-12">
              ...
              <div className="relative flex flex-col justify-between overflow-hidden rounded-3xl border border-white/5 bg-white/5 p-6 sm:p-10">
